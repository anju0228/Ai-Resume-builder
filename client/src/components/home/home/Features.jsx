...
const Features = () => {
  ...
  return (
    <div id="features" className="flex flex-col items-center my-10">
      ...
      <Title
        className="text-center text-lg font-bold font-size-1xl mt-4"
        
        title="Build your resume"
        description="Craft a standout resume effortlessly with our AI-powered builder. Choose from stunning templates, customize with ease, and land your dream job faster than ever!"
      />
