...
const CallToAction = () => {
    ...
    return (
        <div  id="cta"className="border-y border-dashed border-slate-200 w-full max-w-5xl mx-auto px-16 mt-20 mb-20">
            <div className="flex flex-col md:flex-row text-center md:text-left items-center justify-between gap-8  md:px-10 border-x border-dashed border-slate-200 py-20 -mt-10 -mb-10 w-full max-w-5xl mx-auto px-10 sm:px-20">
