...
const Footer = () => {
    ...
    return (
        <>
        <footer className="px-6 md:px-16 lg:px-24 xl:px-32  bg-blue-50" >  
            <div className="flex flex-col md:flex-row items-start justify-center gap-10 py-10 border-b border-gray-500/30 bg-blue-50">
        ...
        <p className="py-4 text-center text-xs md:text-sm bg-[#7668ff] text-white">
