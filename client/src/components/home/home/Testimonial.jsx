    ...
    <>
      ...
      >
        <div className="flex items-center gap-2 text-sm text-blue-800 bg-blue-400/10 border border-indigo-200 rounded-full px-4 py-1">
          {/* <BookUserIcon className="size-4.5 stroke-blue-800" /> */}

          <span>Simple Process</span>
        </div>
        <Title
          title="Don't just take our word for it"
          description="Hear what our users have to say about their experience with our AI-powered resume builder. From job seekers landing interviews to professionals crafting standout resumes, discover how our tool has transformed careers and helped users achieve their goals."
        />
      </div>
